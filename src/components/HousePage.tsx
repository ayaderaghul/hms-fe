...
//   useEffect(loadHouseSummary, [houseId]);


//   if (error) return <p className="text-sm text-red-600">{error}</p>;
//   if (!house) return <p className="text-sm">Loading house...</p>;
//   if (!houseSummary) return <p className="text-sm">Loading house summary...</p>;
...
//         <h2 className="text-[20px] font-semibold">{house.name}: {houseSummary.doneTasks}/{houseSummary.totalTasks}</h2>
//         <button
